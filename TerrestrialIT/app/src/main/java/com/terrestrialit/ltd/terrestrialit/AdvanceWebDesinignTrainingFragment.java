...
public class AdvanceWebDesinignTrainingFragment extends Fragment {

    View view;
    TextView applyfortrainingTXT;
    Context context;

    public AdvanceWebDesinignTrainingFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view=inflater.inflate(R.layout.advance_web_designing_training_fragment,container,false);
        MakeAnimationMathod();
...
//                transaction.commit();
    ...
    public void MakeAnimationMathod(){
        ...
        title.setText(R.string.advance_web_design_training);
