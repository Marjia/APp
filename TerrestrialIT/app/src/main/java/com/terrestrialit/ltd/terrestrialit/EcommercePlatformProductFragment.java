...
public class EcommercePlatformProductFragment extends Fragment {

    View view;

    public EcommercePlatformProductFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view=inflater.inflate(R.layout.ecommerce_platform_product_fragment,container,false);
    ...
    public void MakeAnimationMethod(){
        ...
        title.setText(R.string.ecommerce_platform_product);
