...
public class ServiceFragment extends Fragment {
    ...
    public void AdapterSettingChocolate(){
        ...
        ChocolateOneListView=(ListView)view.findViewById(R.id.chocolate_one_listview_id);
        ServicesCustomAdapter chOnAdapter=new ServicesCustomAdapter(getContext(),ChocolateOneTitleStr,ChocolateOneDetailStr);
        //ServicesCustomAdapter chOnAdapter=new ServicesCustomAdapter(,ChocolateOneTitleStr,ChocolateOneDetailStr);
