...
public class SubmitAQuoteFragment extends Fragment {
...
//    TextView datofbirthtxt;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view=inflater.inflate(R.layout.submit_a_quote_fragment,container,false);
...
//        webView.loadUrl("http://terrestrialit.com/contact/submit-a-quote/");
        return view;
    }
...
//                selectEDT.setText(getdate());
        ...
        ServiceSpinner=(Spinner)view.findViewById(R.id.service_spinner_id);

        ArrayAdapter<String> servicearrayAdapter=new ArrayAdapter<>(getContext(),android.R.layout.simple_spinner_dropdown_item,ServiceProjectSTR);
