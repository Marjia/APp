...
public class ETENDERProductFragment extends Fragment {

    View view;

    public ETENDERProductFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view=inflater.inflate(R.layout.etender_product_fragment,container,false);
    ...
    public void MakeAnimationMethod(){
        ...
        title.setText(R.string.etender);
