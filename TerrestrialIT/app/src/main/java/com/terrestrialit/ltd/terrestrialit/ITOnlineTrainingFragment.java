...
public class ITOnlineTrainingFragment extends Fragment {
    ...
    public ITOnlineTrainingFragment() {
    }
...
//        webView.loadUrl("http://terrestrialit.com/online-it-training-courses/");
...
//                webView.clearView();
        ...
        webView.loadUrl("http://terrestrialit.com/free-seminar-on-freelancing/");
...
//        title.setText(R.string.online_it_training_apply);
