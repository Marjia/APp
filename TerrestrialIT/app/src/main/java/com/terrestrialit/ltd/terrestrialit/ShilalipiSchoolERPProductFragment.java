...
public class ShilalipiSchoolERPProductFragment extends Fragment {

    View view;

    public ShilalipiSchoolERPProductFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view=inflater.inflate(R.layout.shilalipi_school_erp_product_fragment,container,false);
    ...
    public void MakeAnimationMethod(){
        ...
        title.setText(R.string.shilalipi_product);
