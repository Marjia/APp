...
public class CCNATrainingFragment extends Fragment {

    View view;

    public CCNATrainingFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view=inflater.inflate(R.layout.ccna_training_fragment,container,false);
        MakeAnimationMathod();
...
//                transaction.commit();
    ...
    public void MakeAnimationMathod(){
        ...
        title.setText(R.string.advance_ccna_training);
