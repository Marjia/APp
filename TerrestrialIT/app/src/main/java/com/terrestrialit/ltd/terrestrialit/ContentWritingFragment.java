...
public class ContentWritingFragment extends Fragment {

    View view;

    public ContentWritingFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view=inflater.inflate(R.layout.content_writing_fragment,container,false);
        MakeAnimationMathod();
    ...
    public void MakeAnimationMathod(){
        ...
        title.setText(R.string.content_writing_service);
