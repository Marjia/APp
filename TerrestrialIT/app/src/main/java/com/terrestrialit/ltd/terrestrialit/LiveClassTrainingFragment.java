...
public class LiveClassTrainingFragment extends Fragment {
    ...
    public LiveClassTrainingFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view=inflater.inflate(R.layout.live_class_training_fragment,container,false);

//
//        WebView webView=(WebView)view.findViewById(R.id.webview_liveclass_id);
//        webView.getSettings().setJavaScriptEnabled(true);
//        webView.loadUrl("http://online.terrestrialit.com/");
...
//        title.setText(R.string.live_class_training);
