...
public class HospitalManagementSystemProductFragment extends Fragment {

    View view;

    public HospitalManagementSystemProductFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view=inflater.inflate(R.layout.hospital_management_system_product_fragment,container,false);
    ...
    public void MakeAnimationMethod(){
        ...
        title.setText(R.string.hospital_management_system_product);
