...
public class AdvanceGraphicDesinignTrainingFragment extends Fragment {

    View view;

    public AdvanceGraphicDesinignTrainingFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view=inflater.inflate(R.layout.advance_graphic_designing_training_fragment,container,false);
        MakeAnimationMathod();
...
//                transaction.commit();
    ...
    public void MakeAnimationMathod(){
        ...
        title.setText(R.string.advance_graphic_design_training);
